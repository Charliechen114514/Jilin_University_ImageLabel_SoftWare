...
void MainWindow::preLoad()
{
    ...
    this->defLoadImagePath = def_conf[0].split(":").last().remove("\r\n");
    this->defLoadLabelPath = def_conf[1].split(":").last().remove("\r\n");
    this->defAutoLabelSavePath = def_conf[2].split(":").last().remove("\r\n");
}
