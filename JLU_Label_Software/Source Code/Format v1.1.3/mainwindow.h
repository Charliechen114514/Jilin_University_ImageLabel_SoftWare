...
// 默认配置文件的路径
#define DEF_BUILD_CONFPATH "../JLU_Image_TransAnd_Label/conf/conf.txt"
#define DEF_CREATE_EXE_CONF_PATH "./conf/conf.txt"
#define DEF_CONFFILE_PATH DEF_CREATE_EXE_CONF_PATH
...
private slots:
    ...
    /* cvTracker标注，启动！ */
    void on_btn_autoLabel_clicked();
    /* byd存哪 */
    void setAutoLabelSavePath();
    /* 视频追踪启动！ */
    void on_btn_autoLabelVideo_clicked();
...
private:
    ...
    /* 自动标注窗口 */
    AutoLabelWindow*                                autoLabelWnd;
    /* 视频标注窗口 */
    AutoLabelVideoWindow*                           autoLabelVideoWnd;
    /* 刷新默认目录用 */
    bool                                            isRefreshedDefImagePath;
    /* 默认加载图片路径 */
    QString                                         defLoadImagePath;
    /* 默认加载标签路径 */
    QString                                         defLoadLabelPath;
    /* 默认自动保存路径 */
    QString                                         defAutoLabelSavePath;
};
#endif // MAINWINDOW_H
