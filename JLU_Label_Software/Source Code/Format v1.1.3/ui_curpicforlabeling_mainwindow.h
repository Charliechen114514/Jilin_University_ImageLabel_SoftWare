...
public:
    ...
    QAction *action_traditionalDebug;
    QAction *action_YOLO;
    QAction *action_checkCurPicInfo;
    QAction *action_showOrHideSaveInfo;
    ...
    void setupUi(QMainWindow *curPicForLabeling_MainWindow)
    {
        ...
        action_traditionalDebug = new QAction(curPicForLabeling_MainWindow);
        action_traditionalDebug->setObjectName("action_traditionalDebug");
        action_YOLO = new QAction(curPicForLabeling_MainWindow);
        action_YOLO->setObjectName("action_YOLO");
        action_checkCurPicInfo = new QAction(curPicForLabeling_MainWindow);
        action_checkCurPicInfo->setObjectName("action_checkCurPicInfo");
        action_showOrHideSaveInfo = new QAction(curPicForLabeling_MainWindow);
        action_showOrHideSaveInfo->setObjectName("action_showOrHideSaveInfo");
        ...
        menu_7->addAction(action_traditionalDebug);
        menu_7->addAction(action_YOLO);
        menu_8->addAction(action_checkCurPicInfo);
        menu_9->addAction(action_showOrHideSaveInfo);
    ...
    void retranslateUi(QMainWindow *curPicForLabeling_MainWindow)
    {
        ...
        action_traditionalDebug->setText("标准标注");
        action_YOLO->setText("YOLO格式标注");
        action_checkCurPicInfo->setText("查看");
        ...
        menu_7->setTitle("标注TXT格式");
        menu_8->setTitle("查看当前信息");
        menu_9->setTitle("高级");
    } // retranslateUi
